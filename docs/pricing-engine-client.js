/**
 * Client-side port of src/pricingEngine.js — same logic, kept in sync by hand.
 * Used only as a fallback when there is no backend to talk to (e.g. this site
 * hosted as static files on GitHub Pages). See docs/mock-client.js.
 */
(function () {
  const ADDON_LABELS = {
  ...
  window.DealzPricingEngine = { calculateQuote };
})();
